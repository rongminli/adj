...
public class BSTTree2Test extends TestCase {
    ...
    public BSTTree2<Integer, String> createTree() {
        ...
        BSTTree2.BSTNode<Integer, String> n7 = new BSTTree2.BSTNode<>(7, "盈利");
    ...
    private Boolean isSameTree(BSTTree2.BSTNode<Integer, String> tree1, BSTTree2.BSTNode<Integer, Object>  tree2) {
        ...
        if (!Objects.equals(tree1.key, tree2.key)) {
            return false;
        }
